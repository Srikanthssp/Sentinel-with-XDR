...
1. Now you need to setup a analytics rule to get alerts as a incident in the Sentinel, under **Rule templates** search for **Microsoft Entra ID**. Select any desired template and click on **Create rule**.
